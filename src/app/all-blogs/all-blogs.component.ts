...
/**
 * This component will be used to return a paginated list of all the blogs.
 * @usageNotes
 * changePage method can be used to navigate to any given page
 */
@Component({
...
export class AllBlogsComponent implements OnInit {
  ...
  // This method will return a paginated list of all the blogs.
  getAllBlogs() {
  ...
  // This method can be used to navigate to any given page
  changePage(page) {
