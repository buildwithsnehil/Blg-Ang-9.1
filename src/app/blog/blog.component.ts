...
/**
 * This component will be used to manage a blog post like adding comment, reactions, etc.
 */
@Component({
  selector: 'app-blog',
...
export class BlogComponent implements OnInit, OnDestroy {
  ...
  // Can be used to get the logged in user data
  getLoggedInUserData(){
  ...
  // Can be used to get the blog details based on the given blogId
  ...
  // Can be used to add a comment to a blog
  ...
  // Can be used to add a reaction to a blog
  doReact(reactName) {
    if( !this.User.data ){
      return;
    }
